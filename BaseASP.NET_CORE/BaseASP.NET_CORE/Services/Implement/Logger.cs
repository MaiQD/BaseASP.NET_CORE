...
namespace BaseASP.NET_CORE.Services.Implement
{
	...
	public partial class DefaultLogger : ILogger
	{
		...
		{
			var entities = _logRepository.Table.ToList();
			_logRepository.Delete(entities);
		...
		public virtual NhatKy InsertLog(LogLevel logLevel, string shortMessage, string fullMessage = "", NguoiDung customer = null)
		{
		...
		public virtual void Information(string message, Exception exception = null, NguoiDung customer = null)
		{

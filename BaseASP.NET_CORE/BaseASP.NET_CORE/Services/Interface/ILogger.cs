...
namespace BaseASP.NET_CORE.Services.Interface
{
	...
	public partial interface ILogger
	{
		...
		NhatKy InsertLog(LogLevel logLevel, string shortMessage, string fullMessage = "", NguoiDung customer = null);
		...
		void Information(string message, Exception exception = null, NguoiDung customer = null);
